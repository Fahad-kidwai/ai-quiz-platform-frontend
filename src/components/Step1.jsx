...
const Step1 = () => {
  return (
    <div className="min-h-screen md:min-h-[90vh] md:max-h-[53rem] bg-slate-50 border-t  border-[#d3e5e9] rounded-t-[4vw] px-4 sm:px-6 md:px-12 lg:px-36 py-4 md:sticky md:top-0">
