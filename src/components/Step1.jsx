...
const Step1 = () => {
  return (
    <div className="md:sticky border-t border-[#d3e5e9] md:top-0  rounded-t-[4vw] h-[90vh] max-h-[53rem]  px-10  md:px-36 py-4 bg-slate-50">
      <div className="flex flex-col gap-8">
        <div className=" inline-block">Step 1</div>
