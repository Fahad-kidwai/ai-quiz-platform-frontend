...
const Step2 = () => {
  return (
    <div className="md:sticky md:top-16 mb-16 border-t border-[#d3e5e9] rounded-t-[4vw] h-[90vh] max-h-[53rem] px-10  md:px-36 py-4 bg-slate-50">
      <div className="flex flex-col gap-8">
        <div className=" inline-block">Step 2</div>
